...
SELECT
	...
	AcceptedCmp4,
	AcceptedCmp5,
	Response as AcceptedCmp6
from marketing_campaign
;
-- UNION ALL- Creating a table that lays out the DID NOT RESPOND and RESPONDED from Campaigns 1-6.
SELECT
    '0 = Did Not Respond' AS Response_Label,
    SUM(CASE WHEN AcceptedCmp1 = 0 THEN 1 ELSE 0 END) AS AcceptedCmp1,
    SUM(CASE WHEN AcceptedCmp2 = 0 THEN 1 ELSE 0 END) AS AcceptedCmp2,
    SUM(CASE WHEN AcceptedCmp3 = 0 THEN 1 ELSE 0 END) AS AcceptedCmp3,
    SUM(CASE WHEN AcceptedCmp4 = 0 THEN 1 ELSE 0 END) AS AcceptedCmp4,
    SUM(CASE WHEN AcceptedCmp5 = 0 THEN 1 ELSE 0 END) AS AcceptedCmp5,
    SUM(CASE WHEN Response = 0 THEN 1 ELSE 0 END)     AS AcceptedCmp6
From marketing_Campaign
...
SELECT
    '1 = Responded',
    SUM(CASE WHEN AcceptedCmp1 = 1 THEN 1 ELSE 0 END),
    SUM(CASE WHEN AcceptedCmp2 = 1 THEN 1 ELSE 0 END),
    SUM(CASE WHEN AcceptedCmp3 = 1 THEN 1 ELSE 0 END),
    SUM(CASE WHEN AcceptedCmp4 = 1 THEN 1 ELSE 0 END),
    SUM(CASE WHEN AcceptedCmp5 = 1 THEN 1 ELSE 0 END),
    SUM(CASE WHEN Response = 1 THEN 1 ELSE 0 END)
FROM marketing_campaign;

/*
0 then 1 else 0 end -- for each row, if value is 0 it will count it as 1, otherwise 0
1 then 1 else 0 end -- for each row, if value is 1 the count as 1, otherwise 0
 */

--- Adding to the union all query to provide another column that will count the total DID NOT RESPOND and the total RESPONDED.
SELECT
    '0 = Did Not Respond' AS Response_Label,
    SUM(CASE WHEN AcceptedCmp1 = 0 THEN 1 ELSE 0 END) AS AcceptedCmp1,
    SUM(CASE WHEN AcceptedCmp2 = 0 THEN 1 ELSE 0 END) AS AcceptedCmp2,
    ...
    SUM(CASE WHEN AcceptedCmp5 = 0 THEN 1 ELSE 0 END) AS AcceptedCmp5,
    SUM(CASE WHEN Response = 0 THEN 1 ELSE 0 END)     AS AcceptedCmp6,
    SUM(CASE WHEN AcceptedCmp1 = 0 THEN 1 ELSE 0 END) +
    SUM(CASE WHEN AcceptedCmp2 = 0 THEN 1 ELSE 0 END) +
    SUM(CASE WHEN AcceptedCmp3 = 0 THEN 1 ELSE 0 END) +
    SUM(CASE WHEN AcceptedCmp4 = 0 THEN 1 ELSE 0 END) +
    SUM(CASE WHEN AcceptedCmp5 = 0 THEN 1 ELSE 0 END) +
    SUM(CASE WHEN Response = 0 THEN 1 ELSE 0 END) 
    as Total
From marketing_Campaign
...
/* Results from the query are exported into a csv called "Campaign Responses.csv"*/
...
FROM marketing_campaign
GROUP BY Response;
/* DID NOT RESPOND: 1904 COUNT 85.14% (1904/2236=85.14)
 * RESPONDED: 332 COUNT 14.85%
 1 and 0 were the only responses so I used 1 as responded
 */

-- DO THE SAME FOR ALL CAMPAIGNS
SELECT 
	'AcceptedCmp1' as Campaign,
	sum(case when acceptedCmp1 = 1 then 1 else 0 end) as Responded,
	sum(case when acceptedCmp1 = 0 then 1 else 0 end) as Did_Not_Respond,
	round(sum(case when acceptedcmp1 = 1 then 1 else 0 end) * 100.0/count(*), 2) as Percentage_Responded,
	round(sum(case when acceptedcmp1 = 0 then 1 else 0 end) * 100.0/count(*),2) as Percentage_NoResponse
	-- finding the average by counting the amount respoinded and dividing it by the toal count 2236 and rounding it to 2 decimal places
from marketing_Campaign
...
SELECT 
	'AcceptedCmp2',
	sum(case when acceptedCmp2 = 1 then 1 else 0 end) as Responded,
	sum(case when acceptedCmp2 = 0 then 1 else 0 end) as Did_Not_Respond,
	round(sum(case when acceptedcmp2 = 1 then 1 else 0 end) * 100.0/count(*), 2) as Percentage_Responded,
	round(sum(case when acceptedcmp2 = 0 then 1 else 0 end) * 100.0/count(*),2) as Percentage_NoResponse
from marketing_campaign
...
SELECT 
	'AcceptedCmp3',
	sum(case when acceptedCmp3 = 1 then 1 else 0 end) as Responded,
	sum(case when acceptedCmp3 = 0 then 1 else 0 end) as Did_Not_Respond,
	round(sum(case when acceptedcmp3 = 1 then 1 else 0 end) * 100.0/count(*), 2) as Percentage_Responded,
	round(sum(case when acceptedcmp3 = 0 then 1 else 0 end) * 100.0/count(*),2) as Percentage_NoResponse
from marketing_campaign
...
SELECT 
	'AcceptedCmp4',
	sum(case when acceptedCmp4 = 1 then 1 else 0 end) as Responded,
	sum(case when acceptedCmp4 = 0 then 1 else 0 end) as Did_Not_Respond,
	round(sum(case when acceptedcmp4 = 1 then 1 else 0 end) * 100.0/count(*), 2) as Percentage_Responded,
	round(sum(case when acceptedcmp4 = 0 then 1 else 0 end) * 100.0/count(*),2) as Percentage_NoResponse
from marketing_campaign
...
SELECT 
	'AcceptedCmp5',
	sum(case when acceptedCmp5 = 1 then 1 else 0 end) as Responded,
	sum(case when acceptedCmp5 = 0 then 1 else 0 end) as Did_Not_Respond,
	round(sum(case when acceptedcmp5 = 1 then 1 else 0 end) * 100.0/count(*), 2) as Percentage_Responded,
	round(sum(case when acceptedcmp5 = 0 then 1 else 0 end) * 100.0/count(*),2) as Percentage_NoResponse
from marketing_campaign
...
SELECT 
	...
	sum(case when response = 0 then 1 else 0 end) as Did_Not_Respond,
	round(sum(case when response = 1 then 1 else 0 end) * 100.0/count(*), 2) as Percentage_Responded,
	round(sum(case when response = 0 then 1 else 0 end) * 100.0/count(*),2) as Percentage_NoResponse
from marketing_campaign;

/*Output from query exported as a csv called "Response Distribution.csv"*/
